# Large-display
Large display with time, temperature air and water of the pool when running (or other Mosquito data)
With the esp32.ino files and also the esphome file where I get the temperatures and brightness to display.
